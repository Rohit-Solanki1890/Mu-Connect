...
// 🔍 Test route to verify that auth routes are working
...
router.post('/register', [
  ...
  try {
    ...
    try {
      ...
      await sendEmail({
        email: user.email,
        subject: 'Verify Your Email - Marwadi Connect Pro',
        message: `
          <h2>Welcome to Marwadi Connect Pro!</h2>
...
router.post('/forgot-password', [
  ...
  try {
    ...
    try {
      await sendEmail({
        email: user.email,
        subject: 'Password Reset Request - Marwadi Connect Pro',
        message: `
